...
5. Plot table of non-prospective sample types
6. Plot datasets by amplicon region
7. Plot table of prospective sample types
"""
...
if __name__ == "__main__":
    ...
    plot_celiac_samples_over_time(all_samples_df, OUTPUT_DIR, write_tsv_path="celiac_samples_over_time.tsv")

    # Plot 2: Celiac samples across the world (map)
    plot_celiac_samples_across_world_map(all_samples_df, OUTPUT_DIR, write_tsv_path="celiac_samples_world_map.tsv")

    # Plot 3: Celiac samples per sample site
    plot_celiac_samples_per_sample_site(all_samples_df, OUTPUT_DIR, write_tsv_path="celiac_samples_per_site.tsv")

    # Plot 4: Table of dataset types
    plot_dataset_types(included_datasets_df, OUTPUT_DIR, write_tsv_path="dataset_types.tsv")

    # Plot 5: Table of non-prospective sample types
    ...
    # Plot 7: Table of prospective sample types
