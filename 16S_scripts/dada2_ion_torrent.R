...
# Path to dataset
DATASET_DIR <- "~/Repos/celiac-repository/16S_datasets/16S_27_Fornasaro"
setwd(DATASET_DIR)
# Path to raw data
RAW_DATA_DIR <- "~/Repos/celiac-repository/16S_datasets/16S_27_Fornasaro/fastqs"
...
sample_names <- sapply(strsplit(gsub("\\.fq\\.gz$", "", basename(forward_reads)), ".R1"), `[`, 1)
