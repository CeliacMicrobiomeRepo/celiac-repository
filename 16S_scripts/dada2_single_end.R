...
# This script is used for single end Illumina sequencing
...
# Path to dataset
DATASET_DIR <- "~/Repos/celiac-repository/16S_datasets/16S_62_Tian"
setwd(DATASET_DIR)
# Path to raw data
RAW_DATA_DIR <- "~/Repos/celiac-repository/16S_datasets/16S_62_Tian/fastqs"
...
TRUNC_LENGTH <- 0 # Optional and differs between datasets (!!!)
